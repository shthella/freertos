 ...
 ****************************************************************************/
#define IRQ_RTCPERIOD_SOURCE    19
#define IRQ_RTCALARM_SOURCE     20
#define IRQ_PIT_SOURCE          21
#define IRQ_SPI1_SOURCE         22
#define IRQ_SPI2_SOURCE         23
#define IRQ_I2C_SOURCE          24
#define IRQ_GPIO_SOURCE         25
#define IRQ_UART1_SOURCE        26
#define IRQ_UART2_SOURCE        27
#define IRQ_DMA_SOURCE          28
#define IRQ_BMC_SOURCE          29
#define IRQ_SWINT_SOURCE        30
#define IRQ_SDC_SOURCE          36
#define IRQ_MAC_SOURCE          37
#define IRQ_STANDBY_SOURCE      44
#define IRQ_WAKEUP_SOURCE       45
...
typedef struct {
	...
	__IO unsigned long long MTIMECMP;       /* 0x08 Machine Time Compare (HART0) */
	__IO unsigned long long RESERVED0[509]; /* 0x10 ~ 0xFF7 Machine Timer Compare (HART1 ~ HART#n) */
	__IO unsigned int MTIMESTOP;            /* 0xFF8 Machine Time Stop */
	__IO unsigned int MSIP;                 /* 0xFFC Machine Software Interrupt Pending */
} CLICMT_RegDef;
...
typedef struct {
	...
	__IO unsigned int SRCADDR;              /* DMA Channel Source Address Register */
	__IO unsigned int DSTADDR;              /* DMA Channel Destination Address Register */
	__IO unsigned int TRANSIZE;             /* DMA Channel Transfer Size Register */
	__IO unsigned int LLP;                  /* DMA Channel Linked List Pointer Register */
} DMA_CHANNEL_REG;
...
#define BMC_BASE                _IO_(0xE0000000)
#define L2C_BASE                _IO_(0xE0500000)
#define DMAC_BASE               _IO_(0xE0E00000)
#define CLIC_BASE               _IO_(0xE2000000)
#define CLICMT_BASE             _IO_(0xE6000000)
 ...
 ****************************************************************************/
#define AE250_PLMT              ((CLICMT_RegDef *) CLICMT_BASE)
#define AE250_DMA               ((DMA_RegDef *)  DMAC_BASE)
#define AE250_SMU               ((SMU_RegDef *)  SMU_BASE)
#define AE250_UART1             ((UART_RegDef *) UART1_BASE)
#define AE250_UART2             ((UART_RegDef *) UART2_BASE)
#define AE250_PIT               ((PIT_RegDef *)  PIT_BASE)
#define AE250_WDT               ((WDT_RegDef *)  WDT_BASE)
#define AE250_RTC               ((RTC_RegDef *)  RTC_BASE)
#define AE250_GPIO              ((GPIO_RegDef *) GPIO_BASE)
#define AE250_I2C               ((I2C_RegDef *)  I2C_BASE)
#define AE250_SPI1              ((SPI_RegDef *)  SPI1_BASE)
#define AE250_SPI2              ((SPI_RegDef *)  SPI2_BASE)
#define AE250_L2C               ((L2C_RegDef *)  L2C_BASE)
